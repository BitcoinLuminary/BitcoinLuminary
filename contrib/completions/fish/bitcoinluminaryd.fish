...
complete --command bitcoinluminaryd --no-files

# Extract options
function __fish_bitcoinluminaryd_get_options
...
complete \
    --command bitcoinluminaryd \
    --arguments "(__fish_bitcoinluminaryd_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete --command bitcoinluminaryd \
...
complete \
    --command bitcoinluminaryd \
    --arguments "(__fish_bitcoinluminaryd_get_options --nofiles)"

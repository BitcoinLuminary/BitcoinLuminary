...
complete --command bitcoinluminary-qt --no-files

# Extract options
function __fish_bitcoinluminaryqt_get_options
...
complete \
    --command bitcoinluminary-qt \
    --arguments "(__fish_bitcoinluminaryqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c bitcoinluminary-qt \
...
complete \
    --command bitcoinluminary-qt \
    --arguments "(__fish_bitcoinluminaryqt_get_options --nofiles)"

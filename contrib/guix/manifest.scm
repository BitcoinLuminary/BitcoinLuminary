...
(define* (make-bitcoinluminary-cross-toolchain target
                                       #:key
...
desirable for building BitcoinLuminary Core release binaries."
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-bitcoinluminary-cross-toolchain target)))

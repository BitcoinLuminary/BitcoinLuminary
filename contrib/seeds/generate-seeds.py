...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINLUMINARY_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINLUMINARY_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoinluminary network\n')
    ...
    g.write('#endif // BITCOINLUMINARY_CHAINPARAMSSEEDS_H\n')

...
""" Example logging BitcoinLuminary Core mempool events using the mempool:added,
...
def main(bitcoinluminaryd_path):
    bitcoinluminaryd_with_usdts = USDT(path=str(bitcoinluminaryd_path))

    # attaching the trace functions defined in the BPF program
    # to the tracepoints
    bitcoinluminaryd_with_usdts.enable_probe(probe="mempool:added", fn_name="trace_added")
    bitcoinluminaryd_with_usdts.enable_probe(probe="mempool:removed", fn_name="trace_removed")
    bitcoinluminaryd_with_usdts.enable_probe(probe="mempool:replaced", fn_name="trace_replaced")
    bitcoinluminaryd_with_usdts.enable_probe(probe="mempool:rejected", fn_name="trace_rejected")
    bpf = BPF(text=PROGRAM, usdt_contexts=[bitcoinluminaryd_with_usdts])
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("USAGE: ", sys.argv[0], "path/to/bitcoinluminaryd")
        exit(1)

...
""" Interactive bitcoinluminaryd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for BitcoinLuminary Core can enable. It uses BCC
...
def main(bitcoinluminaryd_path):
    ...
    bitcoinluminaryd_with_usdts.enable_probe(

...
EXCLUDE = [
    # auto generated:
    'src/qt/bitcoinluminarystrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    r"Satoshi Nakamoto",
    r"The BitcoinLuminary Core developers",
    r"BitPay Inc\.",
...
Arguments:
    <base_directory> - The base directory of a bitcoinluminary source code repository.
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The BitcoinLuminary Core developers'
...
Arguments:
    <file> - A source file in the bitcoinluminary repository.
"""

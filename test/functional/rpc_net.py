...
class NetTest(BitcoinLuminaryTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=17154)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 17154)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=17154), {"success": False})

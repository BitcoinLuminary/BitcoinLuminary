...
# TestP2PConn: A peer we use to send messages to bitcoinluminaryd, and store responses.
...
class CompactBlocksTest(BitcoinLuminaryTestFramework):
    ...
    # This test actually causes bitcoinluminaryd to (reasonably!) disconnect us, so do this last.
    ...
    # bitcoinluminaryd's choice of nonce.
    ...
    # Test that bitcoinluminaryd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for bitcoinluminaryd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # bitcoinluminaryd will not send blocktxn responses for blocks whose height is

...
By default, bitcoinluminaryd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinluminaryd from writing mempool.dat to disk. Verify that `savemempool` fails")

...
"""Verify that starting bitcoinluminary with -h works as expected."""

from test_framework.test_framework import BitcoinLuminaryTestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinluminary with -h for help text")
        ...
        self.log.info("Start bitcoinluminary with -version for version information")
        ...
        self.log.info("Start bitcoinluminaryd with -fakearg to make sure it does not start")

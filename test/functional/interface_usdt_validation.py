...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/bitcoinluminary/bitcoinluminary/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/bitcoinluminary/bitcoinluminary/blob/master/doc/tracing.md#tracepoint-validationblock_connected

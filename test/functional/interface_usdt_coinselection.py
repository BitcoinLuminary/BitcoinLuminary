...
"""  Tests the coin_selection:* tracepoint API interface.
     See https://github.com/bitcoinluminary/bitcoinluminary/blob/master/doc/tracing.md#context-coin_selection
"""
...
class CoinSelectionTracepointTest(BitcoinLuminaryTestFramework):

...
"""
Test starting bitcoinluminaryd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that bitcoinluminaryd has bound on "::1" (for RPC) and "::" (for P2P).

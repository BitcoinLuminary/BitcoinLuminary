...
class TestShell:
    """Wrapper Class for BitcoinLuminaryTestFramework.

    The TestShell class extends the BitcoinLuminaryTestFramework
    ...
    class __TestShell(BitcoinLuminaryTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by BitcoinLuminaryTestFramework child class.
            self.num_nodes = 1

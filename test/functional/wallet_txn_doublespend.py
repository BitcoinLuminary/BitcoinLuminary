...
class TxnMallTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 BTCLM:
        ...
        # First: use raw transaction API to send 1240 BTCLM to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 BTCLM coin each
        ...
        # Node0's balance should be starting balance, plus 50BTCLM for another
        ...
        # Node0's total balance should be starting balance, plus 100BTCLM for

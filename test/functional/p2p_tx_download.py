...
class TxDownloadTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new bitcoinluminaryd instances, as setting mocktimes has long-term effects on when

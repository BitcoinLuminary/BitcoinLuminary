...
class PSBTTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        # Create and fund a raw tx for sending 10 BTCLM
        ...
        self.log.info("Test walletcreatefundedpsbt fee rate of 10000 sat/vB and 0.1 BTCLM/kvB produces a total fee at or slightly below -maxtxfee (~0.05290000)")

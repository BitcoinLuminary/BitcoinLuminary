...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/bitcoinluminary/bitcoinluminary/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(BitcoinLuminaryTestFramework):

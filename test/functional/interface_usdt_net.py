...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/bitcoinluminary/bitcoinluminary/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our bitcoinluminaryd node")

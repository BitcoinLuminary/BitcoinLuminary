...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the BitcoinLuminaryTestFramework
    pass


class ExampleTest(BitcoinLuminaryTestFramework):
    # Each functional test is a subclass of the BitcoinLuminaryTestFramework class.
    ...
    def custom_method(self):
        ...
        BitcoinLuminaryTestFramework class so other tests can use it."""

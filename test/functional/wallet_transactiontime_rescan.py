...
class TransactionTimeRescanTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTCLM and create transactions
        ...
        # generate some btclm to create transactions and check blockcount
        ...
        # send 10 btclm to user's first watch-only address
        self.log.info('Send 10 btclm to user')
        ...
        # send 5 btclm to our second watch-only address
        self.log.info('Send 5 btclm to user')
        ...
        # send 1 btclm to our third watch-only address
        self.log.info('Send 1 btclm to user')

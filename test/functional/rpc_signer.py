...
Verify that a bitcoinluminaryd node can use an external signer command.
...
class RPCSignerTest(BitcoinLuminaryTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart bitcoinluminaryd with -signer=<cmd>',

...
#ifndef BITCOINLUMINARY_IPC_PROCESS_H
#define BITCOINLUMINARY_IPC_PROCESS_H
...
//! IPC process interface for spawning bitcoinluminary processes and serving requests
...
#endif // BITCOINLUMINARY_IPC_PROCESS_H

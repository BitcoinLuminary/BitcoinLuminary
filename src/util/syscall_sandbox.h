...
#ifndef BITCOINLUMINARY_UTIL_SYSCALL_SANDBOX_H
#define BITCOINLUMINARY_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoinluminaryd initialization if BitcoinLuminary Core was compiled
...
#endif // BITCOINLUMINARY_UTIL_SYSCALL_SANDBOX_H

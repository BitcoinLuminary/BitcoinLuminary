...
#ifndef BITCOINLUMINARY_UTIL_SETTINGS_H
#define BITCOINLUMINARY_UTIL_SETTINGS_H
...
//!       https://github.com/bitcoinluminary/bitcoinluminary/pull/15934/files#r337691812)
...
#endif // BITCOINLUMINARY_UTIL_SETTINGS_H

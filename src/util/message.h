...
#ifndef BITCOINLUMINARY_UTIL_MESSAGE_H
#define BITCOINLUMINARY_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's bitcoinluminary address, it must refer to a public key.
...
#endif // BITCOINLUMINARY_UTIL_MESSAGE_H

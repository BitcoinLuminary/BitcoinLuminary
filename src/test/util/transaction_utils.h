...
#ifndef BITCOINLUMINARY_TEST_UTIL_TRANSACTION_UTILS_H
#define BITCOINLUMINARY_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // BITCOINLUMINARY_TEST_UTIL_TRANSACTION_UTILS_H

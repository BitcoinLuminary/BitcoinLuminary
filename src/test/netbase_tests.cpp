...
{
    BOOST_CHECK(TestSplitHost("www.bitcoinluminarycore.org", "www.bitcoinluminarycore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.bitcoinluminarycore.org]", "www.bitcoinluminarycore.org", 0));
    BOOST_CHECK(TestSplitHost("www.bitcoinluminarycore.org:80", "www.bitcoinluminarycore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoinluminarycore.org]:80", "www.bitcoinluminarycore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("127.0.0.1:17154", "127.0.0.1", 17154));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:17154", "127.0.0.1", 17154));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", 0));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:17154", "::ffff:127.0.0.1", 17154));
    BOOST_CHECK(TestSplitHost("[::]:17154", "::", 17154));
    BOOST_CHECK(TestSplitHost("::17154", "::17154", 0));
    BOOST_CHECK(TestSplitHost(":17154", "", 17154));
    BOOST_CHECK(TestSplitHost("[]:17154", "", 17154));
    ...
    BOOST_CHECK(TestSplitHost("www.bitcoinluminarycore.org:65536", "www.bitcoinluminarycore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinluminarycore.org:0", "www.bitcoinluminarycore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.bitcoinluminarycore.org:", "www.bitcoinluminarycore.org:", 0, false));
}
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:17154", "127.0.0.1:17154"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:17154", "[::]:17154"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));

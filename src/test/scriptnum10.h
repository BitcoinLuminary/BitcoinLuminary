...
#ifndef BITCOINLUMINARY_TEST_SCRIPTNUM10_H
#define BITCOINLUMINARY_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from BitcoinLuminary Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // BITCOINLUMINARY_TEST_SCRIPTNUM10_H

      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->bitcoinluminaryAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->bitcoinluminaryAtStartup);
    ...
    ui->bitcoinluminaryAtStartup->setToolTip(ui->bitcoinluminaryAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->bitcoinluminaryAtStartup->setText(ui->bitcoinluminaryAtStartup->text().arg(PACKAGE_NAME));

    ui->openBitcoinLuminaryConfButton->setToolTip(ui->openBitcoinLuminaryConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinLuminaryUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoinluminaryAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSBTCLMontrols);
...
void OptionsDialog::on_openBitcoinLuminaryConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinLuminaryConf())

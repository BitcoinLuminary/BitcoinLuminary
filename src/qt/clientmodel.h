...
#ifndef BITCOINLUMINARY_QT_CLIENTMODEL_H
#define BITCOINLUMINARY_QT_CLIENTMODEL_H
...
/** Model for BitcoinLuminary network client. */
...
#endif // BITCOINLUMINARY_QT_CLIENTMODEL_H

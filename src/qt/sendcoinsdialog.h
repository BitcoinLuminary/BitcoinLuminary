...
#ifndef BITCOINLUMINARY_QT_SENDCOINSDIALOG_H
#define BITCOINLUMINARY_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending bitcoinluminarys */
...
#endif // BITCOINLUMINARY_QT_SENDCOINSDIALOG_H

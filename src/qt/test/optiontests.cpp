...
{
    // Test regression https://github.com/bitcoinluminary/bitcoinluminary/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitcoinluminary-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitcoinluminary-core/gui/pull/568.
    // With fListen=false in ~/.config/BitcoinLuminary/BitcoinLuminary-Qt.conf and all else left as default,
    // bitcoinluminary-qt should set both -listen and -listenonion to false and start successfully.

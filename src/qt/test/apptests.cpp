...
//! Entry point for BitcoinLuminaryApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinLuminaryApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinLuminaryGUI tests.
void AppTests::guiTests(BitcoinLuminaryGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinLuminaryGUI::consoleShown, this, &AppTests::consoleTests);

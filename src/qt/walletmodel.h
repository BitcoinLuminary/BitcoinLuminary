...
#ifndef BITCOINLUMINARY_QT_WALLETMODEL_H
#define BITCOINLUMINARY_QT_WALLETMODEL_H
...
/** Interface to BitcoinLuminary wallet from Qt view code. */
...
#endif // BITCOINLUMINARY_QT_WALLETMODEL_H

...
#ifndef BITCOINLUMINARY_QT_GUIUTIL_H
#define BITCOINLUMINARY_QT_GUIUTIL_H
...
/** Utility functions used by the BitcoinLuminary Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "bitcoinluminary:" URI into recipient object, return true on successful parsing
...
#endif // BITCOINLUMINARY_QT_GUIUTIL_H

...
#ifndef BITCOINLUMINARY_PSBT_H
#define BITCOINLUMINARY_PSBT_H
...
struct PartiallySignedTransaction
{
    ...
    /** Merge psbt into this. The two psbts must have the same underlying CTransaction (i.e. the
      * same actual BitcoinLuminary transaction.) Returns true if the merge succeeded, false otherwise. */

...
#ifndef BITCOINLUMINARY_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINLUMINARY_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoinluminary.
 *
 ...
 *
 * The chacha20-poly1305@bitcoinluminary combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoinluminary cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoinluminary are relatively fast in
...
#endif // BITCOINLUMINARY_CRYPTO_CHACHA_POLY_AEAD_H

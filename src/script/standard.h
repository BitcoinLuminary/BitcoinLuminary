...
#ifndef BITCOINLUMINARY_SCRIPT_STANDARD_H
#define BITCOINLUMINARY_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a bitcoinluminary address
 */
...
/**
 * Generate a BitcoinLuminary scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // BITCOINLUMINARY_SCRIPT_STANDARD_H

...
#ifndef BITCOINLUMINARY_SCRIPT_SCRIPT_H
#define BITCOINLUMINARY_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, BitcoinLuminary always counted CHECKMULTISIGs
...
#endif // BITCOINLUMINARY_SCRIPT_SCRIPT_H

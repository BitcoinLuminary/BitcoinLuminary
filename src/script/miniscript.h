...
#ifndef BITCOINLUMINARY_SCRIPT_MINISCRIPT_H
#define BITCOINLUMINARY_SCRIPT_MINISCRIPT_H
...
//! Parse a miniscript from a bitcoinluminary script
...
#endif // BITCOINLUMINARY_SCRIPT_MINISCRIPT_H

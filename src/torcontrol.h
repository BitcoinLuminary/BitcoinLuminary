 ...
 */
#ifndef BITCOINLUMINARY_TORCONTROL_H
#define BITCOINLUMINARY_TORCONTROL_H
...
/****** BitcoinLuminary specific TorController implementation ********/
...
#endif // BITCOINLUMINARY_TORCONTROL_H

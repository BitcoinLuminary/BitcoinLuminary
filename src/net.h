...
#ifndef BITCOINLUMINARY_NET_H
#define BITCOINLUMINARY_NET_H
...
public:
     ...
     * @see https://github.com/bitcoinluminary/bitcoinluminary/issues/21744 for details.
     */

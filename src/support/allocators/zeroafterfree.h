...
#ifndef BITCOINLUMINARY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define BITCOINLUMINARY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // BITCOINLUMINARY_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H

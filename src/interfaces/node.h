...
#ifndef BITCOINLUMINARY_INTERFACES_NODE_H
#define BITCOINLUMINARY_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoinluminary node (bitcoinluminaryd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or bitcoinluminary.conf.
...
#endif // BITCOINLUMINARY_INTERFACES_NODE_H

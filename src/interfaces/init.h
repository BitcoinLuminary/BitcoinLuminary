...
#ifndef BITCOINLUMINARY_INTERFACES_INIT_H
#define BITCOINLUMINARY_INTERFACES_INIT_H
...
//! (bitcoinluminary-gui, bitcoinluminary-node, bitcoinluminary-wallet, bitcoinluminaryd, bitcoinluminary-qt) and each
...
#endif // BITCOINLUMINARY_INTERFACES_INIT_H

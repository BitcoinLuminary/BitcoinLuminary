...
#ifndef BITCOINLUMINARY_HEADERSSYNC_H
#define BITCOINLUMINARY_HEADERSSYNC_H
 ...
 *
 * The BitcoinLuminary protocol does not offer an easy way to determine the work on a
...
#endif // BITCOINLUMINARY_HEADERSSYNC_H

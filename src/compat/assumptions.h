...
#ifndef BITCOINLUMINARY_COMPAT_ASSUMPTIONS_H
#define BITCOINLUMINARY_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "BitcoinLuminary cannot be compiled without assertions."
#endif
...
#endif // BITCOINLUMINARY_COMPAT_ASSUMPTIONS_H

...
#ifndef BITCOINLUMINARY_RPC_PROTOCOL_H
#define BITCOINLUMINARY_RPC_PROTOCOL_H
...
//! BitcoinLuminary RPC error codes
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in bitcoinluminaryd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< BitcoinLuminary is not connected
...
#endif // BITCOINLUMINARY_RPC_PROTOCOL_H

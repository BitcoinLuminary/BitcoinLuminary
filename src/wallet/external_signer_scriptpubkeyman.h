...
#ifndef BITCOINLUMINARY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define BITCOINLUMINARY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // BITCOINLUMINARY_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H

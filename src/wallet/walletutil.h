...
#ifndef BITCOINLUMINARY_WALLET_WALLETUTIL_H
#define BITCOINLUMINARY_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoinluminary from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINLUMINARY_WALLET_WALLETUTIL_H

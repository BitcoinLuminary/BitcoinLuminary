...
#ifndef BITCOINLUMINARY_WALLET_TRANSACTION_H
#define BITCOINLUMINARY_WALLET_TRANSACTION_H
...
public:
     ...
     * on this bitcoinluminary node, and set to 0 for transactions that were created
...
#endif // BITCOINLUMINARY_WALLET_TRANSACTION_H

...
#ifndef BITCOINLUMINARY_ARITH_UINT256_H
#define BITCOINLUMINARY_ARITH_UINT256_H
...
public:
     ...
     *
     * BitcoinLuminary only uses this "compact" format for encoding difficulty
...
#endif // BITCOINLUMINARY_ARITH_UINT256_H

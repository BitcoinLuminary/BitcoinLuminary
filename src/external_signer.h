...
#ifndef BITCOINLUMINARY_EXTERNAL_SIGNER_H
#define BITCOINLUMINARY_EXTERNAL_SIGNER_H
...
private:
    ...
    //! BitcoinLuminary mainnet, testnet, etc
    std::string m_chain;
...
#endif // BITCOINLUMINARY_EXTERNAL_SIGNER_H

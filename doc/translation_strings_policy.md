...
This document provides guidelines for internationalization of the BitcoinLuminary Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoinluminary_en.ts` remains unchanged.

BitcoinLuminary Core version *0.15.0.1* is now available from:

  <https://bitcoinluminary.org/bin/bitcoinluminary-core-0.15.0.1/>

and

  <https://bitcoincore.org/bin/bitcoinluminary-core-0.15.0.1/>

Download URL: https://sourceforge.net/projects/bitcoinluminary/files/BitcoinLuminary/bitcoinluminary-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BTCLM fee schedule (users still pay 0.01 BTCLM per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinluminary00 - #bitcoinluminary99

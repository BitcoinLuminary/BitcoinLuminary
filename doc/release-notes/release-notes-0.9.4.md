BitcoinLuminary Core version 0.9.4 is now available from:

  https://bitcoinluminary.org/bin/0.9.4/
...
this update is incompatible with the BitcoinLuminary system and could lead to consensus
forks.

BitcoinLuminary Core released binaries from https://bitcoinluminary.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoinluminary/+archive/ubuntu/bitcoinluminary
- A third-party or self-compiled BitcoinLuminary Core

upgrade to BitcoinLuminary Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

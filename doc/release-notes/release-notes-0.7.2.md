BitcoinLuminary version 0.7.2 is now available from:
  http://sourceforge.net/projects/bitcoinluminary/files/BitcoinLuminary/bitcoinluminary-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused BitcoinLuminary-Qt to crash on Windows when exiting.

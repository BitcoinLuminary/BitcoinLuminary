BitcoinLuminary Core version 0.9.2.1 is now available from:

  https://bitcoinluminary.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BTCLM to 0.01 BTCLM
...
- Fix "Start bitcoinluminary on system login"

BitcoinLuminary-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoinluminary/files/BitcoinLuminary/bitcoinluminary-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BitcoinLuminary
...
New/changed settings (command-line or bitcoinluminary.conf file)
--------------------------------------------------------

BitcoinLuminary version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinluminary/files/BitcoinLuminary/bitcoinluminary-0.5.4/
...
http://gitorious.org/bitcoinluminary/bitcoinluminaryd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinLuminary-Qt notifications under Growl 1.3.
Increase required age of BitcoinLuminary-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinLuminary properly when installing BitcoinLuminary-Qt over it. (Windows)

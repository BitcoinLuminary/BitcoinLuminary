BitcoinLuminary Core version 0.13.2 is now available from:

  <https://bitcoinluminary.org/bin/bitcoinluminary-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoinluminary-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoinluminary-tx to create v2 transactions (btclmdrak)

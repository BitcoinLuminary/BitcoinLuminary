BitcoinLuminary Core version 0.10.4 is now available from:

  <https://bitcoinluminary.org/bin/bitcoinluminary-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinluminary-tx into its own package
- #6953 `dfe0d4d` Include bitcoinluminary-tx binary on Debian/Ubuntu
